...
from quati.reporter import Reporter
from quati.stats import Stats
...
class Trainer:
    ...
    def __init__(
        ...
        tagset = train_iter.dataset.fields['target'].vocab.stoi
        if options.f1_pos_label is not None:
            f1_pos_label = tagset[options.f1_pos_label]
        else:
            f1_pos_label = None
        self.train_stats = Stats(f1_pos_label, options.f1_average)
        self.dev_stats = Stats(f1_pos_label, options.f1_average)
        self.test_stats = Stats(f1_pos_label, options.f1_average)
