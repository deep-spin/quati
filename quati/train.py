...
from quati import iterator
from quati import models
from quati import optimizer
from quati import opts
from quati import scheduler
from quati import dataset
from quati.dataset import fields
from quati.dataset.corpora import available_corpora
from quati.trainer import Trainer
from quati.utils import save_attention
...
def run(options):
    ...
    if not options.load:
        ...
        fields.build_vocabs(fields_tuples, train_dataset, options)
        loss_weights = None
