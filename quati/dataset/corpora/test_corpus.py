# TODO: write tests using pytest properly


def quick_test(corpus_cls, corpus_path, lazy=True, **kwargs):
    from quati.dataset import available_datasets
    from quati.dataset.modules.lazy_iterator import LazyBucketIterator
    ...
    dataset_cls = available_datasets[train_corpus.task]
    dataset = dataset_cls(train_examples, fields_tuples, filter_pred=filter_len)
    print('BUILD VOCAB')
    print('=====================')
